...
const producer = async (content) => {
    console.log("CONSUMER--1", content);
    await channel.sendToQueue(QUEUE_NAME, Buffer.from(JSON.stringify(content)));
    console.log("CONSUMER--2", content);
    consumer();
  };
